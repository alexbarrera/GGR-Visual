...
Tfs = {
  ...
  'FOSL2': new Mongo.Collection("FOSL2"),
  'BCL3': new Mongo.Collection("BCL3"),
  'HES2': new Mongo.Collection("HES2"),
  'CEBPB': new Mongo.Collection("CEBPB"),
  'EP300': new Mongo.Collection("EP300")
};
Dnases = {
